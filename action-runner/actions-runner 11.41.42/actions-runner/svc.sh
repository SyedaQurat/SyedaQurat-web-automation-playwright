...
SVC_NAME="actions.runner.SyedaQurat-web-automation-playwright.Syedas-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (SyedaQurat-web-automation-playwright.Syedas-Air)"
